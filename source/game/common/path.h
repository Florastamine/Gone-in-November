...
#define PRAGMA_PRINT "\nResources lookup module initialization..."
    ...
    // What a waste.
    #define __PATH_LOOKUP_SAVE         "./save/"
...
#else
    #include "./source/game/bind/bindings.h" // If PERFORM_PATH_LOOKUP isn't enabled, we have to directly looking in the root folder,
